...
\`datetime, humidity, temperature, pm2.5_atm, pm2.5_atm_a,
pm2.5_atm_b\`. These are sufficient for simple QC using \`pm2.5_atm_a,
pm2.5_atm_b\` and simple correction using linear fit models based on
