...
Synoptic and time series dataframes returned by `Clarity_~` and `OpenAQ_~` functions
have no dedicated functions but are easily manipulated using the **dplyr** package.
