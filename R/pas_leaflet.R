...
#' @param parameter Optional parameter used to color locations, e.g. `pm25_1hr`.
...
#'
#' When `parameter` is specified, it is assumed that a *pas* object
...
#' use the `parameter` argument to display pm25 values from one of:
#' \itemize{
#' \item{"pm2.5_10minute"}
#' \item{"pm2.5_30minute"}
#' \item{"pm2.5_60minute"}
