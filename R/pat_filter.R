...
#'
#' @title General purpose data filtering for *pat* time series objects
#'
#' @param pat *pat* object.
#' @param ... Logical predicates defined in terms of the variables in
#' `pat$data`.
#'
#' @description A generalized data filter for *pat* objects to
...
#' for an empty *pat* object at the end of the pipeline.
#'
#' @note Filtering is done on values in `pat$data`.
#'
